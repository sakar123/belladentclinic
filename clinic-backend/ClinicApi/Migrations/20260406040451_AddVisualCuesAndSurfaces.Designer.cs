...
namespace ClinicApi.Migrations
{
    ...
    [Migration("20260406040451_AddVisualCuesAndSurfaces")]
    partial class AddVisualCuesAndSurfaces
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClinicApi.Models.Entities.DiscountType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created_at = new DateTime(2026, 4, 6, 4, 4, 50, 786, DateTimeKind.Utc).AddTicks(3710),
                            discount_name = "Senior Citizen",
                            discount_percentage = 10m,
                            updated_at = new DateTime(2026, 4, 6, 4, 4, 50, 786, DateTimeKind.Utc).AddTicks(3710)
                        },
                        new
                        {
                            id = new Guid("782b35f4-1252-4de6-a710-9b2681112f7f"),
                            created_at = new DateTime(2026, 4, 6, 4, 4, 50, 786, DateTimeKind.Utc).AddTicks(4120),
                            discount_name = "Student",
                            discount_percentage = 5m,
                            updated_at = new DateTime(2026, 4, 6, 4, 4, 50, 786, DateTimeKind.Utc).AddTicks(4120)
                        });
                });
            ...
            modelBuilder.Entity("ClinicApi.Models.Entities.ToothStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            code = "HEALTHY",
                            created_at = new DateTime(2026, 4, 6, 4, 4, 50, 786, DateTimeKind.Utc).AddTicks(6150),
                            description = "Healthy",
                            updated_at = new DateTime(2026, 4, 6, 4, 4, 50, 786, DateTimeKind.Utc).AddTicks(6150)
                        },
                        new
                        {
                            id = new Guid("665eb447-6d2e-4889-97b0-ea80c931c7bd"),
                            code = "CAVITY",
                            created_at = new DateTime(2026, 4, 6, 4, 4, 50, 786, DateTimeKind.Utc).AddTicks(6540),
                            description = "Cavity",
                            updated_at = new DateTime(2026, 4, 6, 4, 4, 50, 786, DateTimeKind.Utc).AddTicks(6540)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            code = "OTHER",
                            created_at = new DateTime(2026, 4, 6, 4, 4, 50, 786, DateTimeKind.Utc).AddTicks(6550),
                            description = "Other",
                            updated_at = new DateTime(2026, 4, 6, 4, 4, 50, 786, DateTimeKind.Utc).AddTicks(6550)
                        });
                });
