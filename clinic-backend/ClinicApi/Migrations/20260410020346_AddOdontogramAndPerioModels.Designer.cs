...
namespace ClinicApi.Migrations
{
    ...
    [Migration("20260410020346_AddOdontogramAndPerioModels")]
    partial class AddOdontogramAndPerioModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClinicApi.Models.Entities.DiscountType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            created_at = new DateTime(2026, 4, 10, 2, 3, 46, 376, DateTimeKind.Utc).AddTicks(3090),
                            discount_name = "Senior Citizen",
                            discount_percentage = 10m,
                            updated_at = new DateTime(2026, 4, 10, 2, 3, 46, 376, DateTimeKind.Utc).AddTicks(3090)
                        },
                        new
                        {
                            id = new Guid("782b35f4-1252-4de6-a710-9b2681112f7f"),
                            created_at = new DateTime(2026, 4, 10, 2, 3, 46, 376, DateTimeKind.Utc).AddTicks(3490),
                            discount_name = "Student",
                            discount_percentage = 5m,
                            updated_at = new DateTime(2026, 4, 10, 2, 3, 46, 376, DateTimeKind.Utc).AddTicks(3490)
                        });
                });
            ...
            modelBuilder.Entity("ClinicApi.Models.Entities.ToothStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            code = "HEALTHY",
                            created_at = new DateTime(2026, 4, 10, 2, 3, 46, 376, DateTimeKind.Utc).AddTicks(5500),
                            description = "Healthy",
                            updated_at = new DateTime(2026, 4, 10, 2, 3, 46, 376, DateTimeKind.Utc).AddTicks(5500)
                        },
                        new
                        {
                            id = new Guid("665eb447-6d2e-4889-97b0-ea80c931c7bd"),
                            code = "CAVITY",
                            created_at = new DateTime(2026, 4, 10, 2, 3, 46, 376, DateTimeKind.Utc).AddTicks(5940),
                            description = "Cavity",
                            updated_at = new DateTime(2026, 4, 10, 2, 3, 46, 376, DateTimeKind.Utc).AddTicks(5940)
                        },
                        new
                        {
