...
import { INSTAGRAM_URL, FACEBOOK_URL, WHATSAPP_URL } from '@/lib/socialLinks';
        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-lg">
            <CardContent className="p-6 space-y-4">
              ...
              <ContactLink icon={MessageCircle} href={WHATSAPP_URL} label={t.whatsappLabel} ariaLabel={t.whatsappLabel} />
              <ContactLink icon={Instagram} href={INSTAGRAM_URL} label={t.instagramLabel} ariaLabel={t.instagramLabel} />
              <ContactLink icon={Facebook} href={FACEBOOK_URL} label={t.facebookLabel} ariaLabel={t.facebookLabel} />
            </CardContent>
          </Card>
